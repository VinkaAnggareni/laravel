            ...
            <div id="left-menu">
              <div class="sub-left-menu scroll">
                <ul class="nav nav-list">
                    ...
                    <a href="{{route('barang.index')}}"> <span class="tree-toggle nav-header"><span class="fa-home fa"></span> Barang  <span class="fa-angle-right fa right-arrow text-right"></span></a>
                    ...
                    <li class="ripple">
                      ...
                      <span class="fa-diamond fa"></span> Penjual  <span class="fa-angle-right fa right-arrow text-right"></span></a>
                    ...
                    <li class="ripple">
                      <a class="tree-toggle nav-header">
                      <a href="{{route('barang.index')}}"><span class="fa-area-chart fa"></span>  Pembeli  <span class="fa-angle-right fa right-arrow text-right"></span></a>
                    
                    </li>
                    <li class="ripple"><a class="tree-toggle nav-header">
                    
                    <a href="{{route('supplier.index')}}"><span class="fa fa-pencil-square"></span> Supplier  <span class="fa-angle-right fa right-arrow text-right"></span> </a>
                    </li>
                   <li class="ripple"><a class="tree-toggle nav-header"><span class="fa fa-check-square-o"></span> Gudang  <span class="fa-angle-right fa right-arrow text-right"></span> </a>
                      
                    </li>
                   <li class="ripple"><a class="tree-toggle nav-header"><span class="fa fa-table"></span> Pembelian  <span class="fa-angle-right fa right-arrow text-right"></span> </a>
                      
                    </li>
                    <li class="ripple"><a href="calendar.html"><span class="fa fa-calendar-o"></span>Penjualan  <span class="fa-angle-right fa right-arrow text-right"></span></a></li>
                    <li class="ripple"><a class="tree-toggle nav-header"><span class="fa fa-envelope-o"></span> Detai Penjualan <span class="fa-angle-right fa right-arrow text-right"></span> </a>
                     
                    </li>
                    <li class="ripple"><a class="tree-toggle nav-header"><span class="fa fa-file-code-o"></span> Detail Pembelian  <span class="fa-angle-right fa right-arrow text-right"></span> </a>
